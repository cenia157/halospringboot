                ...
                <div class="paging-div">
                  ...
                  <c:choose>
                    <c:when test="${curPageNo > 5}">
                      <a href="/qna/question?p=${curPageNo - 5}">
                        <button><<</button>
                      </a>
                    </c:when>
                    <c:when test="${curPageNo <= 5 && curPageNo > 1}">
                      <a href="/qna/question?p=1">
                        <button><<</button>
                      </a>
                    </c:when>
                    <c:otherwise>
                  ...
                  <c:choose>
                    <c:when test="${curPageNo > 1}">
                      <a href="/qna/question?p=${curPageNo - 1}">
                        <button>前の</button>
                      </a>
                    </c:when>
                    <c:otherwise>
...
<!-- 경고 -->
                  ...
                  >
					...
					<!-- 버튼 모양 결정 -->
                    <a
                      href="/qna/question?p=${pageNumber}"
                  ...
                  <c:choose>
                    ...
                    >
                      <a href="/qna/question?p=${pageCount}">
                        <button>>></button>
                      </a>
                    </c:when>
                    <c:otherwise>
