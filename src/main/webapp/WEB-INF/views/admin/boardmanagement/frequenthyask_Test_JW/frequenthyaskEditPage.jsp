...
<body>
	...
	<form id="ck-form" method="post" action="/admin/faq/update">
		<div id="myModal-tblF" class="modal-tbl">
			<div class="modal-title-set">
				<div class="modal-title-tr">
					<div class="modal-title-td-1">
						<div class="real-title">
							<input class="real-title-editor" name="qa_title"
								id="real-title-editor"> <input id="modal-seq" name="qa_seq"
								type="hidden">
	...
	<script
		src="${pageContext.request.contextPath}/admin/boardmanagement/frequenthyask_Test_JW/0.js/testMZ.js"
		type="module"></script>
	<!-- 아래의 스크립트는 입력하지 않은 값이 나올 시 alert 띄우는 용 -->
	<script
		src="${pageContext.request.contextPath}/admin/boardmanagement/frequenthyask_Test_JW/0.js/ValidationItems.js"></script>

	<!-- 여기는 CKEditor에 들어간 값을 서버로 보내는 역할이다 -->
	<script
		src="${pageContext.request.contextPath}/admin/boardmanagement/frequenthyask_Test_JW/0.js/SendCkeditorC.js"></script>
